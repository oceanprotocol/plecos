...
result = plecos.validate_file(path_to_json)
...
result = plecos.validate_file(path_to_json, schema_file=path_to_schema)
assert not result

# Alternatively, you can return True/False with the .is_valid function
result = plecos.is_valid_file(path_to_json, path_to_schema)
assert result
