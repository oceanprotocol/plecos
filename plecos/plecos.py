...
LOCAL_SCHEMA_FILE = Path(pkg_resources.resource_filename('plecos', 'schemas/metadata_local_v0_1.json'))
assert LOCAL_SCHEMA_FILE.exists(), "Can't find schema file {}".format(LOCAL_SCHEMA_FILE)
REMOTE_SCHEMA_FILE = Path(pkg_resources.resource_filename('plecos', 'schemas/metadata_remote_v0_1.json'))
